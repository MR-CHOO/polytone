...
public record EntityParticleEmitter(
    ...
    public static final SchemaCodec<EntityParticleEmitter> CODEC = SchemaRecord.create(EntityParticleEmitter.class, i -> i.group(
                    ...
                    i.optional("target_texture", CodecUtils.predicate(Identifier.CODEC), EntityParticleEmitter::textureId),
                    i.optional("target_etf_variant", CodecUtils.predicate(Codec.INT), EntityParticleEmitter::etfVariant),
                    i.optional("target_emf_variant", CodecUtils.predicate(Codec.INT), EntityParticleEmitter::emfVariant),
