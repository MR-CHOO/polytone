...
public record BlockParticleEmitter(
    ...
    public static final SchemaCodec<BlockParticleEmitter> CODEC = SchemaRecord.create(BlockParticleEmitter.class, i -> i.group(
            ...
            i.field("state_predicate", CodecUtils.lenientWithLog(RuleTest.CODEC, "state_predicate", AlwaysTrueTest.INSTANCE), RuleTest.CODEC, BlockParticleEmitter::predicate),
