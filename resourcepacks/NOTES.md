...
"overlays": { "entries": [
  { "directory": "reversed_z", "formats": [0, 0],   "min_format": 88, "max_format": 90 },
...
- 1.21.1 parser: accepts pack via `supported_formats` (pack_format 75≠34); applies `1.21.1` overlay
  (`formats:[34,34]` matches), skips `reversed_z` (`formats:[0,0]` never matches 34). Parses fine —
  every entry has `formats`.
- Newer parser (26.x): applies `reversed_z` via `min_format`/`max_format` 88–90 (ignores its
  `formats:[0,0]`); skips `1.21.1` (34–34 ≠ 88). Unchanged 26.x behavior.
